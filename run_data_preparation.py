...
train_data= data_preparation(base = 'D:\Randomforest', image_dir = '/training_dataset/*', 
                             layer_name = 'block5_pool', feature_name = 'train_features.csv', 
                             label_name = 'tarin_label.csv')
...
test_data =  data_preparation(base ='D:\Randomforest',  image_dir = '/Validation-Example1/*', 
                              layer_name = 'block5_pool', feature_name = 'test_features.csv', 
