...
class BaseModels:
    ...
    def logistic_regression(self, features, labels, test_features, file_name = None):
    ...
    def ada_boost(self, features, labels,  test_features, file_name = None):
        self.features = features
        self.labels = labels
        self.test_features = test_features
        self.file_name = file_name
    ...
    def Randomforest(self, features, labels, test_features, file_name = None):
        self.features = features
        self.labels = labels
        self.test_features = test_features
        self.test_features = test_features
...
class Metamodel:
    ...
    def XGBoost_predictProba(self, concatenated_data, label, file_name):  
        ...
        pickle_out = open(file_name, 'wb')
        pickle.dump(model_xg, pickle_out)
        pickle_out.close()
        return model_xg 
    
    def XGBoost_predict(self, concatenated_data, label, file_name):
         self.concatenated_data = concatenated_data
         self.file_name = file_name
         params = {'max_depth':3, 'eta':0.01,'silent':1,  'num_class':4,'objective':'multi:softmax' } 
         dataset = xgboost.DMatrix(concatenated_data, label )
...
layer_1A.Randomforest(features = train_features, labels = train_labels, test_features = None, file_name = os.getcwd() + '/YOLO/randomforest_b1.pickle')
...
layer_1A.ada_boost(features = train_features, labels = train_labels, test_features = None, file_name = os.getcwd() + '/YOLO/abaBoost_b2.pickle')
